...
Sprint 2: Improved Retrieval, Prompt v0.3, Failure Mode Fixes
"""
...
st.markdown('<p class="sub-header">AI Product Intelligence Platform · Sprint 2</p>', unsafe_allow_html=True)
st.divider()
...
with st.sidebar:
    ...
    st.caption(f"Themes: {len(THEME_KEYWORDS)} · Prompt: `{PROMPT_VERSION}`")
    st.divider()
